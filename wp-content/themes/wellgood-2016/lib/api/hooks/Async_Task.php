...
abstract class Async_Task {
		...
		public function remove_hooks(){
			...
			remove_action( "admin_post_wp_async_$action", array( $this, 'handle_postback' ) );
			remove_action( "admin_post_nopriv_wp_async_$action", array( $this, 'handle_postback' ) );
		}
		...
		public function launch_on_shutdown() {
			if ( ! empty( $this->_body_data ) ) {
				...
				if (is_local()) $url = str_replace('https','http',$url);
