...
class ImageLinks_Public {
	...
	public function enqueue_styles() {
		...
		//[lite]wp_enqueue_style( $this->plugin_name . '_imagelinks_wp', $plugin_url . 'lib/imagelinks.wp.css', array(), $this->version, 'all' );
	}
...
?>
<?php // JavaScript code
	echo '<script class="imagelinks-script" type="text/javascript">' . PHP_EOL;
	echo 'function ' . $func . '() {'. PHP_EOL;
		echo 'WellGood.jQuery( "#' . $id . '" ).imagelinks({' . PHP_EOL;
